...
var address,
  inface = os.networkInterfaces();
for (var dev in inface) {
  inface[dev].filter((details) => {
...
app.post("/portInUse", async (req, res) => {
  var URL = req.body.url;
  URL = URL.toLowerCase();
  console.log(URL);
  ...
  const CommonPorts = [
    7, 20, 21, 22, 23, 25, 53, 54, 69, 80, 88, 8080, 102, 110, 123, 135, 137,
    139, 143, 161, 162, 163, 179, 180, 381, 383, 443, 464, 465, 500, 550, 587,
    593, 636, 691, 902, 989, 990, 993, 995, 1025, 1194, 1337, 1589, 1725, 2082,
    2083, 2483, 2484, 2967, 3074, 3306, 3724, 3389, 4664, 5432, 5900, 6665,
    6669, 6881, 6999, 6970, 8086, 1000, 2000, 3000, 3001, 4000, 5000, 6000,
    8087, 8222, 9100, 10000, 12345, 27374, 18006,
  ];
